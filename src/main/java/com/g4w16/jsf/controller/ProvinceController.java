...
import com.g4w16.jsf.bean.ProvinceFacade;
...
public class ProvinceController implements Serializable {
    ...
    @EJB
    private com.g4w16.jsf.bean.ProvinceFacade ejbFacade;
    ...
    public Province getProvince(java.lang.String id) {
    ...
    public static class ProvinceControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Province) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Province.class.getName());
            }
        }
